...
export default meta;
const Template = (args) => _jsx(AutoComplete, { ...args });
// 模拟建议项数据
...
export const RenderOptionExample = () => (_jsx(AutoComplete, { fetchSuggestions: fetchSuggestions, placeholder: "\u901A\u8FC7renderOption\u81EA\u5B9A\u4E49\u5EFA\u8BAE\u9879\u7684\u6E32\u67D3\u65B9\u5F0F", renderOption: (item) => _jsx("strong", { children: item.value }) }));
